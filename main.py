        ...
        if response.status_code == 200:
            ...
            for article in articles:
                ...
                title_description = f"""Title: {title}, Author: {author}, Source: {source_name}, 
                 Description: {description},  URL: {url}, Content: {content}, Published At: {published_at}"""
...
class AssistantManager:
    ...
    thread_id = "thread_vxV57rkyzyf3Lht2WROlS3Wv"
    assistant_id = "asst_mk7rDV08P8PJsBLOGBepmw5s"
